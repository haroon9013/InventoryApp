...
{
    Task<Result<IReadOnlyList<UnitResponse>>> GetAllAsync(bool includeInactive = false, CancellationToken ct = default);
    Task<Result<UnitResponse>> GetByIdAsync(int id, bool includeInactive = false, CancellationToken ct = default);
